...
def home(request):
    ...
    slides = [
        ('images/slider/slider1.jpg', 'Описание изображения 1'),
        ('images/slider/slider2.jpg', 'Описание изображения 2'),
        ('images/slider/slider3.jpg', 'Описание изображения 3'),
    ]
    ...
    context = {
        ...
        'navs_enabled': 'true',
        'pags_enabled': 'true',
        'slide_numbers': range(1, len(slides) + 1),
    }
...
def employee_list(request):
    employees = User.objects.filter(is_employee=True)  # Выбираем только сотрудников
    return render(request, 'employees.html', {'employees': employees})

def pass_w(request):
    return render(request, "pass_w.html")

def pass_wo(request):
    return render(request, "pass_wo.html")

def anim_test(request):
    return render(request, 'anim_test.html')

def chart_el(request):
