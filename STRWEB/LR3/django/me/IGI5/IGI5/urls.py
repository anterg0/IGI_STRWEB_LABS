...
urlpatterns = [
    ...
    path('reviews/<int:pk>', views.ReviewDetailView.as_view(), name='review-view'),
    ...
    path('sales', views.sales, name='sales-view'),
    ...
    path('pass_w', views.pass_w, name='pass-w'),
    path('pass_wo', views.pass_wo, name='pass-wo'),
    path('anim_test', views.anim_test, name='anim'),
    path('chart', views.chart_el, name='chart')
